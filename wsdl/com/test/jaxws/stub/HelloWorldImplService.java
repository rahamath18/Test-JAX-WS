 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://jaxws.test.com/", wsdlLocation = "http://localhost:9090/ws/hello?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://jaxws.test.com/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9090/ws/hello?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://jaxws.test.com/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://jaxws.test.com/", "HelloWorldImplPort"), HelloWorld.class, features);
    }
